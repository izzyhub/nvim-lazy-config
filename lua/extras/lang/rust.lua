        ...
        rust_analyzer = function(_, opts)
          require("lazyvim.util").on_attach(function(client, buffer)
            ...
            if client.name == "rust_analyzer" then
              vim.keymap.set("n", "K", "<CMD>RustHoverAction<CR>", { buffer = buffer })
              vim.keymap.set("n", "<leader>ct", "<CMD>RustDebuggables<CR>", { buffer = buffer, "Run Test" })
            end
          end)
          ...
          if mason_registry.has_package("codelldb") then
            ...
            local liblldb_path = vim.fn.has("mac") == 1 and extension_path .. "lldb/lib/liblldb.dylb"
